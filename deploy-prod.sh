...
# 운영 서버 배포 스크립트
# 사용법: chmod +x deploy-prod.sh && ./deploy-prod.sh

set -e

ENV_TYPE="production"
APP_NAME="innocean-ai-frontend"
DEFAULT_PORT=3000
ENV_FILE=".env.production"

echo "🚀 [운영] Next.js 앱 배포를 시작합니다..."
...
echo "🌐 [운영] 앱 접속: http://$(curl -s ifconfig.me || echo 'your-ec2-ip'):${PORT}"
